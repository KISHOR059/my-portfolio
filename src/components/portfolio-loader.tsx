    ...
    <AnimatePresence>
      {visible ? (
        <motion.div
          ...
          initial={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          transition={{ duration: reducedMotion ? 0.12 : 0.42, ease: [0.76, 0, 0.24, 1] }}
        >
          ...
          <div className="absolute inset-0 opacity-25 [background-image:radial-gradient(circle,rgba(148,163,184,.48)_1px,transparent_1px)] [background-size:24px_24px] [mask-image:radial-gradient(circle_at_center,black,transparent_72%)]" />
          ...
          >
            <div className="relative grid size-36 place-items-center sm:size-40">
              ...
              <motion.div
                ...
                animate={reducedMotion ? undefined : { scale: [0.92, 1.12, 0.92], opacity: [0.55, 0.9, 0.55] }}
            ...
            <div className="mt-8 w-full">
              <div className="h-px overflow-hidden bg-white/10">
                <motion.div
                  ...
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
                  transition={{ duration: reducedMotion ? 0.25 : 1.3, ease: [0.22, 1, 0.36, 1] }}
                />
              </div>
              <div className="mt-3 flex items-center justify-between gap-2 font-mono text-[8px] uppercase tracking-[.16em] text-slate-500 sm:text-[9px]">
                {bootSteps.map((step, index) => (
                  <motion.span
                    ...
                    transition={{ delay: reducedMotion ? 0 : 0.3 + index * 0.28, duration: 0.3 }}
                  >
