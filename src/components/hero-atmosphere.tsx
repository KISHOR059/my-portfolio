  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      <motion.div
        ...
        animate={calmMotion ? undefined : { x: [0, 90, 20, 0], y: [0, 45, -20, 0], scale: [1, 1.14, 0.94, 1] }}
        transition={{ duration: 18, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute -right-[10%] top-[14%] h-[32rem] w-[32rem] rounded-full bg-blue-500/[.1] blur-[105px]"
        animate={calmMotion ? undefined : { x: [0, -70, 15, 0], y: [0, -25, 55, 0], scale: [1, 0.92, 1.16, 1] }}
      ...
      <motion.div
        ...
        animate={calmMotion ? undefined : { x: ["-30%", "310%"], opacity: [0, 0.8, 0] }}
      ...
      <motion.div
        ...
        animate={calmMotion ? undefined : { y: [0, 22, 0], opacity: [0.045, 0.085, 0.045] }}
      ...
      <div className="absolute right-[4%] top-[14%] hidden size-[34rem] place-items-center lg:grid">
        {[0, 1, 2].map((ring) => (
          <motion.div
            ...
            animate={calmMotion ? undefined : { rotateZ: ring % 2 ? [0, -360] : [0, 360] }}
      ...
      <motion.div
        ...
        animate={calmMotion ? undefined : { left: ["8%", "92%"], opacity: [0, 1, 0] }}
